...
import {
  AccordionData,
  AccordionDataItemType,
} from "@/config/code-selection-items-config";
  ...
  return (
    ...
    >
      <div className="w-full m-2  max-w-full relative rounded-lg">
        <p className="absolute top-0 ml-1 border-b border-r rounded-br-md pr-2 p-1 font-medium border-gray-800 left-0 text-[#4FFA7B]/70 ">
          {AccordionData[currentStep].fileName}
        </p>
        <SyntaxHighlighter
          language="tsx"
          style={nightOwl}
      ...
      <div className="flex flex-col gap-4">
        <p className="text-left max-w-sm text-xl md:text-xl lg:text-2xl xl:text-4xl">
