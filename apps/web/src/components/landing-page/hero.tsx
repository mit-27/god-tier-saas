      ...
      <div className="mt-10 grid grid-cols-1 md:mt-20 min-h-screen">
        <div className="flex flex-col items-start gap-6 px-7 pb-8 text-center md:items-center md:px-10">
          ...
          <div className="relative flex flex-col gap-4 md:items-center lg:flex-row">
            <Title>Build the next Enterprise application</Title>
          </div>
          ...
          <Subtitle>
            ...
            between <LinkPreview url="https://nextjs.org/">Next.js</LinkPreview>{" "}
            and <LinkPreview url="https://nestjs.com/">Nest.js</LinkPreview>,{" "}
            along with integrated services like{" "}
            <LinkPreview url="https://authjs.dev/">AuthJS</LinkPreview> for
            authentication,{" "}
            <LinkPreview url="https://posthog.com/">PostHog</LinkPreview> for
            analytics, and{" "}
            <LinkPreview url="https://orm.drizzle.team/">
              Drizzle ORM
            </LinkPreview>{" "}
            with PostgreSQL for database management.
            <br />
