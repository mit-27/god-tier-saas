...
const HoverButton = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="inline-block transition-all z-30 duration-300 ease-in-out hover:scale-110">
      <div className="p-2 bg-gray-500/10 rounded-full">{children}</div>
    </div>
  );
};
  ...
  return (
    <div className="flex relative z-10 bg-black flex-col gap-4 sm:gap-4 mt-4 border w-full rounded-sm items-center justify-center p-4 max-w-5xl mx-auto min-h-[50vh]">
      <div className="relative z-10 max-w-2xl flex flex-col md:items-center lg:flex-row">
        <Title className="lg:text-4xl md:text-4xl text-2xl text-center  sm:text-2xl">
      ...
      <div className="flex gap-5 flex-wrap mt-3 justify-center items-center max-w-4xl">
        ...
        <HoverButton>
          <img
            src="/images/TechIcons/drizzle.png"
            alt="drizzle"
            className="z-30 w-7 h-7 bg-white rounded-full"
          />
        </HoverButton>

        <HoverButton>
          <img
            src="/images/TechIcons/nextauth.png"
            alt="nextauth"
            className="z-30 w-7 h-7"
          />
        </HoverButton>

        <HoverButton>
          <img
            src="/images/TechIcons/ts-rest.png"
            alt="ts-rest"
            className="z-30 w-6 h-6 m-1"
          />
        </HoverButton>

        <HoverButton>
          <img
            src="/images/TechIcons/nestjs.png"
            alt="nestjs"
            className="z-30 w-7 h-7"
          />
        </HoverButton>
        ...
        <HoverButton>
          <img
            src="/images/TechIcons/postgres.png"
            alt="postgres"
            className="z-30 w-7 h-7"
          />
        </HoverButton>
        ...
        <HoverButton>
          <img
            src="/images/TechIcons/docker.png"
            alt="docker"
            className="z-30 w-7"
          />
        </HoverButton>
