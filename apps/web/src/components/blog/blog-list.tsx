...
export function BlogList({ children, className }: BlogListProps) {
  ...
  return (
    <ul
      className={cn(
        "flex flex-col list-disc pl-6 text-white/80 gap-4",
        className
      )}
    >
      {children}
...
export function BlogListNumbered({ children, className }: BlogListProps) {
  ...
  return (
    <ol
      className={cn(
        "flex flex-col list-decimal pl-6 text-white/80 gap-6 ",
        className
      )}
    >
      {children}
...
export function BlogListItem({ children, className }: BlogListProps) {
  return (
    <li
      className={cn(
        "pl-4 leading-8 font-normal sm:text-lg text-white/80",
        className
      )}
    >
