...
export const AccordionData: AccordionDataItemType[] = [
  {
    ...
    content:
      "Define your API endpoint fields like body, query, pathParams, and headers in the router function using a simple TypeScript type with the c.type helper, or use Zod objects instead.",
    index: 0,
...
export const contract = c.router(
  ...
  },
  {
    ...
    content:
      "Use TsRestHandler to implement the API in the controller and it is also compatible with NestJS decorators.",
    index: 1,
...
export class TodoController {
  ...
  },
  {
    ...
    content:
      "You can use Tanstack query which provides type-safety for your fetch and mutation calls.",
    index: 2,
